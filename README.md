...
- **Fleets of units.** Each technology is one card made of identical units (e.g. 27 coal units of about 700 MW). You set how many are **online**, on warm **standby**, or **offline**, and move the output of all online units together. Units go `offline → warming → standby → starting → online → stopping`: a cold start takes hours (coal 8 h, gas CCGT 2 h, peakers 15 min), from standby much less (coal 1 h, CCGT 30 min, peakers 5 min), and keeping units warm costs money. Units have ramp limits and minimum stable output; nuclear cannot restart within the day. Hydro has a daily water budget, storage a state of charge and round-trip losses (battery 90%, pumped hydro 75%, shown on the cards and counted in the day’s totals), and demand response a daily activation limit. Solar and wind follow the weather and can only be curtailed.
