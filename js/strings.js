...
const en = {
  ...
  'setup.autoBackup': 'Auto: gas peakers as backup',
  'setup.autoBackupHint': 'Peakers wait warm on standby and start by themselves when supply runs short.',
  ...
  'meter.co2Value': '{v} kg/kWh',
  'meter.co2Foot': 'Today {avg} kg/kWh on average · {kt} kt CO₂ so far',
  ...
  'end.gasOil': 'of which gas and oil',
  'end.co2': 'CO₂ emitted',
