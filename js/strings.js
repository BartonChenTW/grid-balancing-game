...
const en = {
  ...
  'unit.pendingStart': '+{n} starting',
  'unit.pendingStop': '−{n} stopping',
  'unit.pendingWarm': '+{n} warming up',
  ...
  'units.hint': 'Space pauses · number keys pick a technology · ↑/↓ output · ←/→ units online',
  ...
  'lb.board': 'Top scores for {board}',
  'lb.nickname': 'Your nickname',
  'lb.submit': 'Submit score',
  'lb.submitting': 'Submitting…',
  'lb.submitted': 'Submitted! You are #{rank} on this board. Your score shows as “checking” until a replay confirms it (usually within 30 minutes).',
  'lb.error': 'Could not reach the leaderboard. Try again later.',
  'lb.notRanked': 'This game is not ranked: only games on a Taiwan fleet go on the leaderboard.',
  'lb.empty': 'No scores yet. Be the first!',
  'lb.loading': 'Loading…',
  'lb.checking': 'checking',
  'lb.verified': 'verified',
  'lb.privacy': 'Stored: your nickname, score, settings and moves (to replay and check the score). No email; the leaderboard does not keep IP addresses.',
  'lb.previewRanked': 'Ranked: finish the day to submit your score.',
  'lb.previewCustom': 'Ranked. Your options differ from the {difficulty} defaults, so your score will be tagged “custom options”.',
  'lb.custom': 'custom options',
  'lb.customHint': 'Played with options other than the difficulty’s defaults (assist, accidents or Auto).',
  'end.downloadReport': 'Download report',
  'end.downloadData': 'Download data (CSV)',
  'report.title': 'Follow the Load: day report',
  'report.generated': 'Generated {date} · {version}',
  'report.setup': 'Setup',
  'report.score': 'Score',
  'report.metrics': 'Key numbers',
  'report.auto': 'Auto modes',
  'report.on': 'on',
  'report.off': 'off',
  'report.costNote': 'Capital cost of building this fleet, levelised at a {rate}% discount rate (range from ±30% build-cost uncertainty). Fuel is not included.',
  'report.dataNote': 'Minute-by-minute numbers are in the CSV download.',
  ...
  'tutorial.4': 'Here you see demand and supply, and what your choices cost right now: CO₂ per kWh and fuel cost per kWh. Burning gas and oil makes both go up.',
