...
const en = {
  ...
  'lb.notRanked': 'This game is not ranked: only Taiwan fleets played with the difficulty’s default options go on the leaderboard.',
  ...
  'lb.previewUnranked': 'Your options differ from the {difficulty} defaults, so this game will not be ranked.',
